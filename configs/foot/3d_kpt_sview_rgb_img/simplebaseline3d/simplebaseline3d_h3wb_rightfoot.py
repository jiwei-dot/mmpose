_base_ = [
    ...
    '../../../_base_/datasets/h3wb_rightfoot3d.py'
]
...
train_pipeline = [
    ...
    dict(
        ...
        item='target',
        norm_param_file=f'{data_root}/annotation_wholebody3d/rfoot_joint3d_rel_stats.pkl'),
    dict(
        type='NormalizeJointCoordinate',
        item='input_2d',
        norm_param_file=f'{data_root}/annotation_wholebody3d/rfoot_joint2d_stats.pkl'),
