_base_ = [
    ...
    '../../../_base_/datasets/h3wb_righthand3d.py'
]
...
train_pipeline = [
    ...
    dict(
        ...
        item='target',
        norm_param_file=f'{data_root}/annotation_wholebody3d/rhand_joint3d_local_global_stats.pkl'),
    dict(
        type='NormalizeJointCoordinate',
        item='input_2d',
        norm_param_file=f'{data_root}/annotation_wholebody3d/rhand_joint2d_stats.pkl'),
